...
while True:
    ...
    if ( ball.xcor > padle_right.xcor - 20  ) and ( ball.ycor <= padle_right.ycor + 50 and ball.ycor >= padle_right.ycor - 50 ):
        ball.dx *= -1
    ...
    if ( ball.xcor <= padle_left.xcor + 20  ) and ( ball.ycor <= padle_left.ycor + 50 and ball.ycor >= padle_left.ycor - 50 ):
        ball.dx *= -1
